...
public interface Sanctuary {
    ...
    /**
     * Add a monkey to the sanctuary by adding it to Isolation.
     *
     ...
     * In other words, Adds monkey to Enclosure after removing it from Isolation.
     *
     * @param monkey the monkey to be added
     ...
     * In other words, produces a list for every enclosure that shows each individual monkey that is currently housed there.
    ...
    /**
     * Produce an alphabetical list of all monkeys (by name) housed in the Sanctuary.
