...
/**
 * This class (containing a main method) shows all the important requirements of the implementation
 * (monkeys in isolation, moving to enclosures, list of monkeys)
 * This class does not need to rely on input from the keyboard.
 *
 * It creates at least one run of this program to verify that it meets all the requirements in rubrics.
 */
public class Driver {
