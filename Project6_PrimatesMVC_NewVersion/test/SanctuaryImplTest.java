...
public class SanctuaryImplTest {
     ...
     * Shows the user is able to register new monkeys into the sanctuary (4.1)
     */
    @Test
    ...
    /**
     * Test whether creatMonkey() method work correctly when given an invalid monkey attribute.
     * Verifies that an exception is thrown if creating an invalid monkey is attempted.
     */
    ...
    /**
     * Test whether addMonkeyFirstToSanctuary() method works correctly.
     * Verifies that a monkey can be added to sanctuary successfully.
     */
    @Test
    public void testAddMonkeyFirstToSanctuary() {
        // add m1 to sanctuary
        sanctuary.addMonkeyFirstToSanctuary(m1);
        String actual = sanctuary.getAlphabetMonkeyList();
        String expected = "Amy ";
        Assert.assertEquals(expected, actual);
    }
    ...
    /**
     * Test whether addMonkeyFirstToSanctuary() method work correctly.
     * Verifies that the user is notified
     * if there is no room for new monkeys in the sanctuary (4.2)
     */
    @Test(expected = IllegalArgumentException.class)
    public void testAddMonkeyFirstToSanctuaryException() {
        ...
        // first add 20 monkeys to Sanctuary
        sanctuary.addMonkeyFirstToSanctuary(m1);
        sanctuary.addMonkeyFirstToSanctuary(m2);
        sanctuary.addMonkeyFirstToSanctuary(m3);
        sanctuary.addMonkeyFirstToSanctuary(m4);
        sanctuary.addMonkeyFirstToSanctuary(m5);
        sanctuary.addMonkeyFirstToSanctuary(m6);
        sanctuary.addMonkeyFirstToSanctuary(m7);
        sanctuary.addMonkeyFirstToSanctuary(m8);
        sanctuary.addMonkeyFirstToSanctuary(m9);
        sanctuary.addMonkeyFirstToSanctuary(m10);
        sanctuary.addMonkeyFirstToSanctuary(m11);
        sanctuary.addMonkeyFirstToSanctuary(m12);
        sanctuary.addMonkeyFirstToSanctuary(m13);
        sanctuary.addMonkeyFirstToSanctuary(m14);
        sanctuary.addMonkeyFirstToSanctuary(m15);
        sanctuary.addMonkeyFirstToSanctuary(m16);
        sanctuary.addMonkeyFirstToSanctuary(m17);
        sanctuary.addMonkeyFirstToSanctuary(m18);
        sanctuary.addMonkeyFirstToSanctuary(m19);
        sanctuary.addMonkeyFirstToSanctuary(m20);

        // add one more monkey will throw exception
        // the user will also be notified in VIEW
        Monkey m21 = new Monkey("Unix", Species.DRILL, Sex.MALE, Size.LARGE, 50, 10, Food.EGGS, false);
        sanctuary.addMonkeyFirstToSanctuary(m21);
    }


    /**
     * Test whether addMonkeyToIsolation method works correctly.
     * Verifies that a monkey can be added to isolation successfully.
     */
    @Test
     ...
     * verifies that the implementation produces
     * a list of monkeys for every enclosure (4.3)
     */
    @Test
     ...
     * verifies the implementation produces an alphabetical list (by name)
     * of all of the monkeys housed in the Sanctuary (4.4)
     */
    @Test
     ...
     * Verifies he implementation does not crash or offer unusual behaviour (4.5)
     */
    @Test(expected = IllegalArgumentException.class)
    ...
    /**
     * Test whether addMonkeyToEnclosure method works correctly when given monkey is not healthy to put in Enclosure.
     * Verifies that a monkey cannot be added to an enclosure if it has not been labelled as healthy.
     * Verifies he implementation does not crash or offer unusual behaviour (4.5)
     */
    @Test(expected = IllegalArgumentException.class)
    public void testAddMonkeyToEnclosureException2() {
        // monkey m1 is not healthy
        // so adding this monkey will throw exception
     ...
     * verifies that the report of species that are currently being housed in the sanctuary is correct
     */
    @Test
