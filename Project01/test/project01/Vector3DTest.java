...
public class Vector3DTest {
  ...
  @Before
  public void setUp() {
    this.vec1 = new Vector3D(0.0, 3.0, 4.0);
    this.vec2 = new Vector3D(1.0, 2.0, 2.0);
    this.vec3 = new Vector3D(0.0, 0.0, 0.0);
  }
  @Test
  public void testGetX() {
    Assertions.assertEquals(0.0, vec1.getX(), 0.001);
    Assertions.assertEquals(1.0, vec2.getX(), 0.001);
  }

  @Test
  public void testGetY() {
    Assertions.assertEquals(3.0, vec1.getY(), 0.001);
    Assertions.assertEquals(2.0, vec2.getY(), 0.001);
  }

  @Test
  public void testGetZ() {
    Assertions.assertEquals(4.0, vec1.getZ(), 0.001);
    Assertions.assertEquals(2.0, vec2.getZ(), 0.001);
  }
  ...
  public void testToString() {
    ...
    String expected1 = "(0.000000, 3.000000, 4.000000)";
    ...
    String expected2 = "(1.000000, 2.000000, 2.000000)";
    ...
    String expected3 = "(0.000000, 0.000000, 0.000000)";
  ...
  public void getMagnitude() {
    ...
    Assertions.assertEquals(5.0, vec1.getMagnitude(), 0.001);

    // test case2: check if vec2's magnitude has the expected result
    Assertions.assertEquals(3.0, vec2.getMagnitude(), 0.001);

    // test case3: check if vec3's magnitude has the expected result
    Assertions.assertEquals(0.0, vec3.getMagnitude(), 0.001);
  }
  ...
  public void testNormalize() {
    ...
    Vector3D expected1 = new Vector3D(0.0 / vec1Magnitude, 3.0 / vec1Magnitude , 4.0 / vec1Magnitude);
    ...
    Vector3D expected2 = new Vector3D(1.0 / vec2Magnitude, 2.0 / vec2Magnitude, 2.0 / vec2Magnitude);
